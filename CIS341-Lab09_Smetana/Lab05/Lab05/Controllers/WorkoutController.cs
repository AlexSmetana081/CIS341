...
namespace Lab05.Controllers
{
    ...
    public class WorkoutController : Controller
    {
        ...
        public IActionResult MakeWorkout()
        {
            MakeWorkoutDTO makeWorkoutDTO = new MakeWorkoutDTO();
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Workouts != null ?
                        View(await _context.Workouts
                            .Include(a => a.Author)
                            .Include(a => a.Exercises).ToListAsync()) :
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Retrieve the workout from the repository or context
            ...
            workoutEntity.Exercises = workoutSets;
