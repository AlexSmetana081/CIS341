            ...
            */
            ...
            var workout3 = new Workout()
            {
                ...
                Exercises = new List<WorkoutSet>()
                {
                    new WorkoutSet()
                    {
                        Exercise = context.Exercises.FirstOrDefault(e => e.ExerciseId == 5),
                         Reps = 4,
                         Sets= 2,
                         Weight= 5,
                    },
                    new WorkoutSet() {
                        Exercise = context.Exercises.FirstOrDefault(e => e.ExerciseId == 6),
                         Reps = 4,
                         Sets= 2,
                         Weight= 5,
                    },
            ...
            var workout4 = new Workout()
            {
                ...
                {
                    new WorkoutSet() {
                        Exercise = context.Exercises.FirstOrDefault(e => e.ExerciseId == 7),
                        Reps = 4,
                         Sets= 2,
                         Weight= 5,
                    },
                    new WorkoutSet() {
                        Exercise = context.Exercises.FirstOrDefault(e => e.ExerciseId == 8),
                                                 Reps = 4,
                         Sets= 2,
                         Weight= 5,
                    },
