...
namespace Lab05.Data
{
    ...
    {
        public static void Initialize(WorkoutContext context, WorkoutAuthenticationContext authenticationContext)
        {
            ...
            {
                Name = "subscriber@gmail.info",
            };

            var account12 = new Account()
            {
                Name = "trainer@gmail.info",
            };

            var account13 = new Account()
            {
                Name = "admin@gmail.info",
            };

            // Add Accounts to DbSet
            context.Accounts.AddRange(account1, account2, account3, account4, account5, account6, account7, account8, account9, account10, account11, account12, account13);
            context.SaveChanges();

            //Get the users from the authentication DB
            var users = authenticationContext.Users.ToList();
